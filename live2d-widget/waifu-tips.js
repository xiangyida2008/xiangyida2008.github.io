...
function loadWidget(config) {
	...
	let userAction = false,
		userActionTimer,
		messageTimer,
		messageArray = ["如果你不知道天子是什么,那么我可以告诉你,它不是邪教~","今天的我依然如此可爱啊~","世界上正确的东西只有科学和天子", "天子万岁", "大坏蛋！你都多久没碰人家了呀，嘤嘤嘤～", "嗨～快来逗我玩吧！", "拿小拳拳锤你胸口！"];
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			if (now > 5 && now <= 6) text = "早上好~您起的真早！很勤奋呢！" ;
			else if (now > 6 && now <= 8) text = "早上好！一日之计在于晨，美好的一天就要开始了呢~加油鸭！";
			else if (now > 8 && now <= 11) text = "上午好！工作顺利嘛，不要久坐，多起来走动走动哦！";
			else if (now > 11 && now <= 14) text = "中午了，工作了一个上午，现在是午餐时间！";
			else if (now > 14 && now <= 16) text = "午后很容易犯困呢，但还是要加油鸭~奥利给！";
			else if (now > 16 && now <= 18) text = "傍晚了，休息一下劳累一天的身子吧";
			else if (now > 18 && now <= 21) text = "晚上好，今天过得怎么样？";
